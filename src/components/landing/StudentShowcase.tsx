...
const STUDENT_SHOWCASE_VIDEO_ID = "FAGz71lZrMY";
const STUDENT_SHOWCASE_START_SECONDS = 75;
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              >
                <a
                  ...
                  onClick={() =>
                    sendMetaEvent("Lead", {
                      source: "StudentShowcase: Reservar Hotel",
                    })
                  }
                >
                  Reservar Hotel por WhatsApp
                </a>
              </Button>
              <Button
                asChild
              ...
              >
                <Link
                  ...
                  onClick={() =>
                    sendMetaEvent("Lead", {
                      source: "StudentShowcase: Conocer Plan",
                    })
                  }
                >
                  Ver Opciones de Hoteles
                </Link>
              </Button>
            </div>
          </div>
